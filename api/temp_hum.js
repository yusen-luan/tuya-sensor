...
const TUYA_ACCESS_ID = 'vry5rc8grpntpcmctame'; // Your Tuya Cloud Project Access ID, from your curl command
const TUYA_ACCESS_SECRET = 'YOUR_TUYA_ACCESS_SECRET'; // Your Tuya Cloud Project Access Secret
...
const DEVICE_ID = 'ebf0498211e2397a2bqzuj'; // The ID of your temperature/humidity sensor device
